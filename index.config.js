...
var index_config_default = {
  ...
  danmu: {
    urls: [
      { address: "https://logdanmu.dpdns.org", name: "Eternity默认1" },
      { address: "https://fjj0417.dpdns.org/87654321", name: "Eternity默认2" }, 
      { address: "https://dm.stardm.us.kg:443/87654321", name: "Eternity默认3" }, 
      { address: "https://danmu.14812910.xyz/87654321", name: "Eternity默认4" }, 
      { address: "https://313236.xyz/87654321", name: "Eternity默认5" }
    ],
    autoPush: true
  },
  t4: {list: [
    {name: "✈️ Eternity TG频道",
      address: "http://zhangqun1818.serv00.net:6628/?spider=独播库"},
    {name: "📡 Eternity IPTV直播",
      address: "https://iptv.jsnzkpg.uk"},
    {name: "🐯 Eternity 虎牙直播",
      address: "https://php.doube.eu.org/spider/php/虎牙直播.php"},
    {name: "🅱️ Eternity 哔哩直播",
      address: "https://bilibili.jsnzkpg.uk"},
    {name: "🎞️ Eternity 影视爬虫",
      address: "https://dy.7772888.xyz/api.php/tvbox"},
    {name: "🍟 Eternity Emby嗅探",
      address: "http://zhangqun1818.serv00.net:6628/?spider=emby"},
    {name: "⚡️ Eternity VIP嗅探",
